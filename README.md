...
This document explains how to connect to the latest Testnet of the [Lino Blockchain](https://linotracker.io/).
...
[chat](https://riot.im/app/#/room/!WAWAMHohvBlpTyVtSf:matrix.org) for technical support. Thanks very
